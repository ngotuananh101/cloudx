...
export function FileBrowserHeader({ connection, decodedPath, onNavigateHome }: FileBrowserHeaderProps) {
    return (
            ...
            <div>
                ...
                <div className="mt-1 flex items-center gap-2">
                    {decodedPath ? (
                        ...
                        <h2 className="text-xl font-extrabold tracking-tight text-gray-900">My Files</h2>
                    )}
                </div>
            </div>
        </div>
