...
export default function ConnectionNavItem({ connection, href, isActive, onEditName, onDelete }: ConnectionNavItemProps) {
    return (
        <li>
            <div className={`group relative flex items-center justify-between gap-2 rounded-lg px-3 py-1.5 text-xs font-bold tracking-wide transition-colors ${isActive ? 'bg-red-50 text-brand' : 'text-gray-500 hover:bg-gray-50 hover:text-gray-900'}`}>
